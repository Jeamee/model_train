...
def parse_args():
    ...
    parser.add_argument("--tb_log", type=str, required=False)
    ...
    parser.add_argument("--deepspeed", action="store_true", required=False)
    parser.add_argument("--deepspeed_config", type=str, default="../model", required=False)

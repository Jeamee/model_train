...
--step_scheduler_metric f1 --trans_lr 3e-6 --other_lr 1e-5 --epochs 10 --max_len $MAX_LEN --batch_size $BS --valid_batch_size 4 \
...
--ckpt /workspace/${MODEL#*/}_${DECODER}_bs${BS}_ml${MAX_LEN}_${DATE}/model_6.bin_epoch1

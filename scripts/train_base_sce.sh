...
set -Eeuox
python ../src/train.py --fold 0 --model "allenai/longformer-large-4096" --loss sce --sce_alpha 6.0 --sce_beta 1.0 --step_scheduler_metric f1 --trans_lr 1e-5 --other_lr 1e-3 --epochs 10 --max_len 1536 --batch_size 4 --valid_batch_size 4 --input ~/autodl-tmp/feedback-prize-2021/ --output ~/autodl-tmp/feedback-prize-2021-0211-base --log ../logs/train_base_sce.log
